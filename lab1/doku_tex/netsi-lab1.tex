...
Dies zeigt uns die verwendeten Mailserver sowie die Nameserver inkl. deren IP-Adresse, wobei die Nameserver bereits bei whois aufgelistet sind. Der Befehl "dig fhnw.ch" hat uns leider nicht mehr angezeigt als whois. Es waren also lediglich die Nameserver aufgelistet.
\begin{figure}[p]
	\centering
...
In der folgenden Tabelle sind die PTR-Einträge im DNS für die externe IP-Range der FHNW gelistet. Dies gibt uns nun die Grundlage um die Scanning Phase zu starten.
